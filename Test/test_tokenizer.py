...
from BPETokenizer import BasicTokenizer, RegexTokenizer
...
test_strings = [
    ...
    "FILE:manas.txt", # FILE: is handled as a special string in unpack()
]
def unpack(text):
    ...
    if text.startswith("FILE:"):
        ...
        manas_file = os.path.join(dirname, text[5:])
        contents = open(manas_file, "r", encoding="utf-8").read()
        return contents
    else:
        return text
